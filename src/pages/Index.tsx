...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background circuit-bg">
      ...
      {/* Hero Section - Phase 1: The Squeeze */}
      <section className="relative min-h-screen flex flex-col items-center justify-center px-4 pt-24 pb-12">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          ...
          >
            Watch our free strategy session replay and discover how top companies 
            scale their infrastructure without the chaos.
          </motion.p>
        ...
        <motion.div
          ...
          className="relative z-10 w-full max-w-4xl px-4 mb-12"
        >
          <VideoPlayer />
        </motion.div>
